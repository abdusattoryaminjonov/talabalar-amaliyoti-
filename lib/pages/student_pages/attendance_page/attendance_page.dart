    ...
    return GetBuilder<AttendancePageController>(
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  controller.loadData( attendancePageController.interId,
                    NoSqlService.getLogin()!.accessToken);
                },
              )
            ],
            leading: InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => LogsAndMap(logsByDateList: attendancePageController.logsByDateList,),
                ));
              },
              child: Center(
                child: Image.asset(
          ...
          body:controller.isPageLoading ? Center(
            child: SizedBox(
              width: 150,
              ...
              TableCalendar(
                ...
                calendarBuilders: CalendarBuilders(
                  markerBuilder: (context, date, events) {
                    ...
                    if (!controller.attendancesMap.containsKey(key)) {
                      return null;
                    }
                    return Positioned(
                      bottom: 4,
